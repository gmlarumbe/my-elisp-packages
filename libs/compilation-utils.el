...
(defvar larumbe/compilation-error-re-xrun
  '((xrun-fatal    "\\(?1:^[a-z]+\\): \\(?2:\\*F\\),[0-9A-Z]+\\(?:\\(?:\\[[0-9A-Z_,]+\\]\\)? (\\(?3:[^ \t,]+\\),\\(?4:[0-9]+\\)|\\(?5:[0-9]+\\)\\)" 3 4 5 2 nil (1 larumbe/compilation-binary-face) (2 compilation-error-face))
    (xrun-fatal2   "\\(?1:^[a-z]+\\): \\(?2:\\*F\\),[0-9A-Z]+\\(?:\\(?:\\[[0-9A-Z_,]+\\]\\)? (\\(?3:[^ \t,]+\\),\\(?4:[0-9]+\\)\\)" 3 4 nil 2 nil (1 larumbe/compilation-binary-face) (2 compilation-error-face))
    (xrun-fatal3   "\\(?1:^[a-z]+\\): \\(?2:\\*F\\),[0-9A-Z]+:" 1 nil nil 2 nil (1 larumbe/compilation-binary-face) (2 compilation-error-face))
    (xrun-error    "\\(?1:^[a-z]+\\): \\(?2:\\*E\\),[0-9A-Z]+\\(?:\\(?:\\[[0-9A-Z_,]+\\]\\)? (\\(?3:[^ \t,]+\\),\\(?4:[0-9]+\\)|\\(?5:[0-9]+\\)\\)" 3 4 5 2 nil (1 larumbe/compilation-binary-face) (2 compilation-error-face))
    (xrun-error2   "\\(?1:^[a-z]+\\): \\(?2:\\*E\\),[0-9A-Z]+\\(?:\\(?:\\[[0-9A-Z_,]+\\]\\)? (\\(?3:[^ \t,]+\\),\\(?4:[0-9]+\\)\\)" 3 4 nil 2 nil (1 larumbe/compilation-binary-face) (2 compilation-error-face))
    (xrun-error3   "\\(?1:^[a-z]+\\): \\(?2:\\*E\\),[0-9A-Z]+:" 1 nil nil 2 nil (1 larumbe/compilation-binary-face) (2 compilation-error-face))
    ...
    (xrun-warning2 "\\(?1:^[a-z]+\\): \\(?2:\\*W\\),[0-9A-Z]+\\(?:\\(?:\\[[0-9A-Z_,]+\\]\\)? (\\(?3:[^ \t,]+\\),\\(?4:[0-9]+\\)\\)" 3 4 nil 1 nil (1 larumbe/compilation-binary-face) (2 compilation-warning-face))
    (xrun-warning3 "\\(?1:^[a-z]+\\): \\(?2:\\*W\\),[0-9A-Z]+:" 1 nil nil 1 nil (1 larumbe/compilation-binary-face) (2 compilation-warning-face))
    (xrun-note     "\\(?1:^[a-z]+\\): \\(?2:\\*N\\),[0-9A-Z]+\\(?:\\(?:\\[[0-9A-Z_,]+\\]\\)? (\\(?3:[^ \t,]+\\),\\(?4:[0-9]+\\)|\\(?5:[0-9]+\\)\\)" 3 4 5 0 nil (1 larumbe/compilation-binary-face) (2 compilation-info-face))
    (xrun-note2    "\\(?1:^[a-z]+\\): \\(?2:\\*N\\),[0-9A-Z]+\\(?:\\(?:\\[[0-9A-Z_,]+\\]\\)? (\\(?3:[^ \t,]+\\),\\(?4:[0-9]+\\)\\)" 3 4 nil 0 nil (1 larumbe/compilation-binary-face) (2 compilation-info-face))
    (xrun-note3    "\\(?1:^[a-z]+\\): \\(?2:\\*N\\),[0-9A-Z]+:" 1 nil nil 0 nil (1 larumbe/compilation-binary-face) (2 compilation-info-face))
    ;; UVM
